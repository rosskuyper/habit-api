...
export const DDB_USERS_TABLE = env.get('DDB_USERS_TABLE').required().asString()
export const DDB_TOKENS_TABLE = env.get('DDB_TOKENS_TABLE').required().asString()
...
export const CORS_ALLOWED_ORIGINS = env.get('CORS_ALLOWED_ORIGINS').required().asArray()
